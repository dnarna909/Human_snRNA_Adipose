...
seurat.file = c("SAT_Label_2000.Rds")
file.type = "Subtype.metadata.Rds";Select_Group = "Select_Group"; # separate by group
rmarkdown::render(input= paste0(Disk, Project.folder, "/", "Main_07_Adipogenesis_Fat_1.Trajectory_Step1_2000.R"), 
                  output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
...
seurat.file = c("SAT_Label_2000.Rds")
file.type = "Subtype.metadata.Rds";Select_Group = "Select_Group"; # separate by group
rmarkdown::render(input= paste0(Disk, Project.folder, "/", "Main_07_Adipogenesis_Fat_1.Trajectory_Step1.R"), 
                  output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
...
seurat.file = c("SAT_Label_2000.Rds")
file.type = "Subtype.metadata.Rds";Select_Group = "Select_Group"; # separate by group
rmarkdown::render(input= paste0(Disk, Project.folder, "/", "Main_07_Adipogenesis_Fat_1.Trajectory_Step1_AFE.R"), 
                  output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
...
path = "Branch_3"
rmarkdown::render(input= paste0(Disk, Project.folder, "/", "Analysis_AssociationMarkers_Pt.R"), 
                  output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
...
Select.Group = "Compare_Group2"; compare.group = "Pre_Post";
groups = c("Pre", "Post");
rmarkdown::render(input= paste0(Disk, Project.folder, "/", "Analysis_PatternTestMarkers_Pt_SGLT2i.R"), 
                  output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
                                          paste0('Analysis_PatternTestMarkers_Pt_', 
                                                 ...
                                                 '.html')))
rm(seurat.file, path, Select.Group, compare.group, groups)

### Generate Trajectory Markers ------
seurat.file = "Differentiation_PHATE_3000.Rds";path = "Branch_3";
Select.Group = "Compare_Group2"; compare.group = "Pre_Post";
groups = c("Pre", "Post");
rmarkdown::render(input= paste0(Disk, Project.folder, "/", "Analysis_TrajectoryMarkers_Pt_SGLT2i.R"), 
                  output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
...
seurat.file = "Differentiation_PHATE_3000.Rds";path = "Branch_3";
Select.Group = "Compare_Group1"; compare.group = "BA_Group"; 
groups = c("Older_Lean", "Older_Overweight", "Older_PreD_Obese", "Diabetes");
rmarkdown::render(input= paste0(Disk, Project.folder, "/", "Analysis_TrajectoryMarkers_Pt.R"), 
                  output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
                                          paste0('Analysis_TrajectoryMarkers_Pt_SGLT2i_', 
                                                 unlist(stringr::str_split(seurat.file, ".Rds"))[1], "_",
...
Select.Group = "Compare_Group1"; compare.group = "BA_Group";
groups = c("Older_Lean", "Older_Overweight", "Older_PreD_Obese", "Diabetes");
rmarkdown::render(input= paste0(Disk, Project.folder, "/", "Analysis_PatternTestMarkers_Pt.R"), 
                  output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
                                          paste0('Analysis_PatternTestMarkers_Pt_', 
                                                 unlist(stringr::str_split(seurat.file, ".Rds"))[1], "_",
...
seurat.file = "Differentiation_PHATE_3000.Rds";path = "Branch_3";
Select.Group = "Compare_Group3"; compare.group = "Age_Group";
...
# seurat.file = "Differentiation_PHATE_3000.Rds";path = "Branch_3";
# Select.Group = "Compare_Group2"; compare.group = "Treatment_Group";
...
rmarkdown::render(input= paste0(Disk,"00_Functions_Refs", "/FunctionCodes/", "Main_07_AssociationMarkers_CombinebyGroup.R"), 
                  ...
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
                                          paste0('Main_07_AssociationMarkers_CombinebyGroup_', 
                                                 ...
                                                 Select.Group, "_", 
                                                 groups, '.html')))
rm(markers.files, sample.file.type, Select.Group, groups,row.by )

markers.files = c(
  "AssocationMarkers/Differentiation_PHATE_3000_Pt.DEGs.Rds"
); 
sample.file.type = "SAT_Sample.meta.data.Rds"; # sample files
Select.Group = "Compare_Group1"; Compare.G = "BA_Group";
groups = "Differentiation"; row.by = "Dataset"
rmarkdown::render(input= paste0(Disk,"00_Functions_Refs", "/FunctionCodes/", "Main_07_AssociationMarkers_CombinebyGroup.R"), 
                  output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
                                          paste0('Main_07_AssociationMarkers_CombinebyGroup_', 
                                                 ...
                                                 Select.Group, "_", 
                                                 groups, '.html')))
rm(markers.files, sample.file.type, Select.Group, groups, Compare.G,row.by )
...
sample.file.type = "SAT_Sample.meta.data.Rds"; # sample files
Select.Group = "Compare_Group2"; Compare.G = "Treatment_Group";
groups = "Differentiation"; row.by = "Dataset"
rmarkdown::render(input= paste0(Disk,"00_Functions_Refs", "/FunctionCodes/", "Main_07_AssociationMarkers_CombinebyGroup.R"), 
                  output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
                                          paste0('Main_07_AssociationMarkers_CombinebyGroup_', 
                                                 ...
                                                 Select.Group, "_", 
                                                 groups, '.html')))
rm(markers.files, sample.file.type, Select.Group, groups,Compare.G  )

markers.files = c(
  "AssocationMarkers/Differentiation_PHATE_3000_Pt.DEGs.Rds"
); 
sample.file.type = "SAT_Sample.meta.data.Rds"; # sample files
Select.Group = "Compare_Group3"; Compare.G = "Age_Group";
groups = "Differentiation"; row.by = "Dataset"
rmarkdown::render(input= paste0(Disk,"00_Functions_Refs", "/FunctionCodes/", "Main_07_AssociationMarkers_CombinebyGroup.R"), 
                  output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
...
sample.file.type = "SAT_Sample.meta.data.Rds"; # sample files
Select.Group = "Compare_Group2"; Compare.G = "Group";
...
rmarkdown::render(input= paste0(Disk, Project.folder,  "/", "Mean_Plotting_AssociationMarkers_Dataset.R"), output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
...
Select.Group = "Compare_Group1"; export.folder <- paste0("AssociationMarkers");
rmarkdown::render(input= paste0(Disk, Project.folder,  "/", "Mean_Plotting_Markers_level2_1ANOVA.R"), output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"),
                                          paste0('Mean_Plotting_Markers_level2_sample_id_',
                                                 Select.Group, "_", "Subtype",
                                                 '.html')))
rm(markers.files, Select.Group)
...
rmarkdown::render(input= paste0(Disk,"00_Functions_Refs", "/FunctionCodes/", "Main_07_MarkersLevel2_CombinebyGroup.R"), 
                  ...
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
                                          paste0('Main_07_MarkersLevel2_CombinebyGroup_', 
                                                 Select.Group, "_", meta.group, '.html')))
rm(markers.files, sample.file.type, meta.group, Select.Group)
...
rmarkdown::render(input= paste0(Disk,"00_Functions_Refs", "/FunctionCodes/", "Main_07_MarkersLevel2_CombinebyGroup.R"), 
                  ...
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
                                          paste0('Main_07_MarkersLevel2_CombinebyGroup_', 
                                                 Select.Group, "_", meta.group, '.html')))
rm(markers.files, sample.file.type, meta.group, Select.Group, Compare.G)
...
rmarkdown::render(input= paste0(Disk, Project.folder,  "/", "Analysis_DEGs_zlm.Regression.R"), 
                  output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
...
rmarkdown::render(input= paste0(Disk, Project.folder,  "/", "Analysis_DEGs_zlm.Regression_Multiple.R"), 
                  output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
...
# 13. Markers plotting -----------------------------------------------
## Mean & scatter plotting for level2 Markers ---------
markers.files = c(
  "FindMarkers_SAT_Label_2000/Annotation.Level2.Markers/SAT_Label_2000_Annotation.Select_Group_Combined.RData"
); 
Select.Group = "Select_Group"; 
rmarkdown::render(input= paste0(Disk, Project.folder,  "/", "Mean_Plotting_Markers_level2_sample_id.R"), output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
                                          paste0('Mean_Plotting_Markers_level2_sample_id_', 
                                                 Select.Group, "_", "Annotation",
                                                 '.html')))
rm(markers.files, Select.Group)
...
## VlnPlot plotting for level2 Markers ---------
seurat.files =  c("SAT_Label_2000.Rds"); file.type = "Subtype.metadata.Rds"; 
sample.file.type = "SAT_Sample.meta.data.Rds"; # sample files
Select.Group = "Select_Group"; group.x = "Annotation";
markers.files = c(
  "FindMarkers_SAT_Label_2000/Annotation.Level2.Markers/SAT_Label_2000_Annotation.Select_Group_Combined.Mean.Rds"
); 
rmarkdown::render(input= paste0(Disk, Project.folder,  "/", "Plotting_Markers_level2_VlnPlot.R"), output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
                                          paste0('Plotting_level2_Markers_VlnPlot_', 
                                                 Select.Group, "_", "Annotation",
                                                 '.html')))
rm(seurat.files , file.type, sample.file.type, markers.files, Select.Group, group.x)



## Mean & scatter plotting for level2 Markers by Group ---------
### 1ANOVA ---------------------------
markers.files = c(
  "FindMarkers_SAT_Label_2000/Subtype.Level2.Markers/SAT_Label_2000_Adipocytes_Subtype.Compare_Group1_Combined.RData"
);
...
Select.Group = "Compare_Group1";  Compare.G = "BA_Group"; compare.groups = c("Older_Lean", "Older_Overweight", "Older_PreD_Obese", "Diabetes");
rmarkdown::render(input= paste0(Disk, Project.folder,  "/", "Mean_Plotting_Markers_level2_1ANOVA_All.R"), output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"),
...
Select.Group = "Compare_Group2"
rmarkdown::render(input= paste0(Disk, Project.folder,  "/", "Mean_Plotting_Markers_level2_2ANOVA.R"), output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"),
                                          paste0('Mean_Plotting_Markers_level2_sample_id_',
                                                 Select.Group, "_", "Subtype",
                                                 '.html')))
...
Select.Group = "Compare_Group3"
rmarkdown::render(input= paste0(Disk, Project.folder,  "/", "Mean_Plotting_Markers_level2_ttest.R"), output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"),
                                          paste0('Mean_Plotting_Markers_level2_sample_id_',
                                                 Select.Group, "_", "Subtype",
                                                 '.html')))
...
Select.Group = "Select_Group"; group.x = "Annotation";
Markers_file =c("Fat_Subtype.xlsx"); sheet = "Annotation_Markers";
rmarkdown::render(input= paste0(Disk, Project.folder,  "/", "Plotting_Markers_VlnPlot.R"), output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
                                          paste0('Plotting_Markers_VlnPlot_', 
                                                 Select.Group, "_", "Annotation",
                                                 '.html')))
rm(seurat.files , file.type, sample.file.type, Markers_file, Select.Group, group.x, sheet)
...
file.type = "Subtype.metadata.Rds"; Select.Group = "Select_Group"; 
rmarkdown::render(input= paste0(Disk, Project.folder, "/","Plotting_seurat_Features.R"), output_format= "html_document",
                  output_file = file.path(
                    paste0(Disk, Project.folder, "/", "html.result"), 
                    paste0('Plotting_seurat_Features', 
                           ifelse(length(features) >2, paste0(paste(features[1:2], collapse = "."), "_", length(features) ),
                                  paste(features, collapse = ".") ), '.html')) )# 11∶24∶58 PM 
rm(seurat.files, features,  file.type, Select.Group )
