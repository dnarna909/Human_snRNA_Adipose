...
rmarkdown::render(input= paste0(Disk, Project.folder,  "/", "CellMarkerstoPathway_Analysis_Plotting_GProfiler.R"), output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"), 
...
sample.file.type = "Samples.df.Rds"; # sample files
Select_Group = "Compare_Group2";  Compare.G = "Treatment_Group"; compare.groups = c("NUT_Pre", "NUT_Post", "SGLT2i_Pre", "SGLT2i_Post");
rmarkdown::render(input= paste0(Disk, Project.folder,  "/", "Mean_Plotting_Markers_level2_2ANOVA_All.R"), output_format= "html_document",
                  output_file = file.path(paste0(Disk, Project.folder, "/", "html.result"),
