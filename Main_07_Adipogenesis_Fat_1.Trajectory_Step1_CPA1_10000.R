...
if(!file.exists(paste0(Disk, Project.folder, "/", Rds.folder, "/","Adipogenesis_PHATE.", name, ".Rds"))) {
  ...
  seurat.data <- FindVariableFeatures(seurat.data, nfeatures= 10000 ) # (dim(seurat.data)[1]-1 ) # 20000
  ...
  gc() #free up memrory and report the memory usage.
  saveRDS(seurat.data, paste0(Disk, Project.folder, "/", Rds.folder, "/","Adipogenesis_PHATE.", name, ".Rds"))
  gc() #free up memrory and report the memory usage.
} else {
  seurat.data <- readRDS(paste0(Disk, Project.folder, "/", Rds.folder, "/","Adipogenesis_PHATE.", name, ".Rds"))
}
gc() #free up memrory and report the memory usage.
...
saveRDS(PHATE, paste0(Disk, Project.folder, "/", Rds.folder, "/","PHATE.", name, ".Rds"))
saveRDS(seurat.data, paste0(Disk, Project.folder, "/", Rds.folder, "/","Adipogenesis_PHATE.", name, ".Rds"))
gc() #free up memrory and report the memory usage.
