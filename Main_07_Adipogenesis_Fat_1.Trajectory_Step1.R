...
if(!file.exists(paste0(Disk, Project.folder, "/", Rds.folder, "/","Adipogenesis_PHATE_", name, ".Rds"))) {
  ...
  Adipogenesis <- subset(seurat.data, subset = Annotation %in% c("Adipocytes", "FAP"))
  ...
  Adipogenesis <- FindVariableFeatures(Adipogenesis, nfeatures= 5000) # (dim(Adipogenesis)[1]-1 ) # 20000
  ...
  gc() #free up memrory and report the memory usage.
  saveRDS(Adipogenesis, paste0(Disk, Project.folder, "/", Rds.folder, "/","Adipogenesis_PHATE_", name, ".Rds"))
  gc() #free up memrory and report the memory usage.
} else {
  Adipogenesis <- readRDS(paste0(Disk, Project.folder, "/", Rds.folder, "/","Adipogenesis_PHATE_", name, ".Rds"))
}
gc() #free up memrory and report the memory usage.
...
# save files ----------------------------------------------------------------------------------------------------------------------
# saveRDS(PHATE, paste0(Disk, Project.folder, "/", Rds.folder, "/","Adipogenesis.PHATE_Rds"))
saveRDS(PHATE, paste0(Disk, Project.folder, "/", Rds.folder, "/","PHATE_", name, ".Rds"))
saveRDS(Adipogenesis, paste0(Disk, Project.folder, "/", Rds.folder, "/","Adipogenesis_PHATE_", name, ".Rds"))
gc() #free up memrory and report the memory usage.
